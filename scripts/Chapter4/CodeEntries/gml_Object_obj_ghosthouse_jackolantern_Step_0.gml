...
if (timer == 1)
{
    if (obj_heart.sprite_index != spr_dodgeheart_long)
    {
        if (obj_growtangle.sprite_index == spr_ghost_house_yourtutu)
        {
            ...
            {
                with (instance_create(camerax() + 320, cameray() + 15, obj_takingtoolong))
                {
                    tutu = 1;
                    alt = true;
                }
                
                snd_play_volume(scr_84_get_sound("snd_tutu_fast"), 0.8);
            ...
            else
            {
                ...
                snd_play_volume(scr_84_get_sound("snd_taking_tutu"), 0.8);
            }
        }
        else if (polite != 0)
        {
            ...
            {
                snd_play_volume(scr_84_get_sound("snd_taking_too_long_fast"), 0.8);
                
                with (instance_create(camerax() + 320, cameray() + 24, obj_takingtoolong))
                    text_speed = 2.5;
            ...
            else
            {
                if (polite == 1)
                {
                    mysnd = snd_play_volume(scr_84_get_sound("snd_alt_takingtoolong"), 0.8);
                }
                else
                {
                    snd_play_volume(scr_84_get_sound("snd_takingtoolongtoolong"), 0.8);
                }
        ...
        {
            snd_play_volume(scr_84_get_sound("snd_taking_too_long"), 0.8);
            
            instance_create(camerax() + 320, cameray() + 24, obj_takingtoolong);
        }
    }
    else if (i_ex(obj_jackenstein_enemy) && obj_jackenstein_enemy.scaredycat)
    {
        with (instance_create(camerax() + 310, y + 80, obj_takingtoolong))
            alt = true;
        
        snd_play(scr_84_get_sound("snd_long_only"));
    ...
    {
        instance_create(camerax() + 310, y + 80, obj_takingtoolong);
        
        snd_play(scr_84_get_sound("snd_your_long"));
    }
}
...
if (small && timer == 130)
{
    snd_play_volume(scr_84_get_sound("snd_taking_too_long_small"), 0.8);
}

if (small && timer == 18 && (i_ex(obj_jackenstein_enemy) && obj_jackenstein_enemy.scaredycat))
{
    snd_play(scr_84_get_sound("snd_taking_too_long_small_fast"));
}

if (timer == ((75 + (115 * small) + (30 * (abs(polite) > 1 && !politer))) - (10 * (polite == 1))) && tutu < 2)
{
    if (small)
        snd_play(scr_84_get_sound("snd_jackolantern_laugh_small"));
    else if (polite != 1)
        snd_play(scr_84_get_sound("snd_jackolantern_laugh"));
    ...
    if (obj_growtangle.sprite_index == scr_84_get_sprite("spr_ghost_house_chimney"))
    {
...
if (tutu == 2)
{
    ...
    if (timer == 240)
    {
        with (instance_create(camerax() + 320, cameray() + 12, obj_takingtoolong))
            tutu = 2;
        
        sound_play(scr_84_get_sound("snd_your_tutu"));
