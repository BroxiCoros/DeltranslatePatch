...
function add_font(argument0, argument1) //gml_Script_add_font
{
    ...
    // `<fnt_name>_chapter4.ttf` (u .otf) en `fonts/`, lo usa con
    ...
    var filename_ttf_chapter = ((path + fnt_name) + "_chapter4.ttf")
    var filename_otf_chapter = ((path + fnt_name) + "_chapter4.otf")
    ...
    if (resolved_path != "") {
        ...
        // capitulo (`_chapter4.ttf`) tambien produce key distinta.
