function add_sprite(argument0, argument1) //gml_Script_add_sprite
{
    ...
    if file_exists(filename)
    {
        ...
        //   chapter4/sprites/sp_1_spr_kris.png  -> modo prefix "sp_1"
        //   chapter4/sprites/sp_2_spr_kris.png  -> modo prefix "sp_2"
        //   chapter4/sprites/sp_spr_kris.png    -> compat viejo ("sp")
        // ===========================================================
        ...
        for (var sp_i = 0; sp_i < array_length(sp_modes); sp_i++)
        {
            ...
            var sp_filename = get_lang_folder_path() + "chapter4/sprites/" + sp_key + ".png"
