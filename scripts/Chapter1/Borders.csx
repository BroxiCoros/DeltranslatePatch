...
QFR("gml_Object_obj_time_Draw_77", "if (scr_is_switch_os() || os_type == os_ps4 || os_type == os_ps5)", "if (true)");

QFR("gml_Object_obj_time_Draw_77", @"var xx = floor((ww - (sw * global.window_scale)) / 2);
...
QFR("gml_Object_obj_time_Draw_77", "draw_surface_ext(application_surface, xx, yy, global.window_scale, global.window_scale, 0, c_white, 1);", @"if (_border_off)
...
QFR("gml_Object_obj_time_Draw_75", "window_set_size(640 * window_size_multiplier, 480 * window_size_multiplier);", "window_set_size(640 * window_size_multiplier, 360 * window_size_multiplier);");
...
QFR("gml_GlobalScript_scr_draw_background_ps4", @"    if (os_type == os_ps4 || os_type == os_ps5 || scr_is_switch_os())
    {
...
QFR("gml_Object_DEVICE_MENU_Step_0", @"if (global.is_console || os_type == os_android)
                        {
