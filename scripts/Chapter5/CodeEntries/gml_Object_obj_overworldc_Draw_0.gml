...
if (global.interact == 5)
{
    ...
    if (global.menuno != 4)
    {
        ...
        var _cellTextColor = _weird_mode ? 8421504 : 16777215;
        draw_set_color(_cellTextColor);
    ...
    if (global.menuno == 2)
    {
        ...
        if (global.lweapon == 22)
            weaponname = stringsetloc("Pencil2", "obj_overworldc_slash_Draw_0_gml_91_0");
        
        if (global.lweapon == 23)
            weaponname = stringsetloc("Petal", "obj_overworldc_slash_Draw_0_gml_92_0_b");
