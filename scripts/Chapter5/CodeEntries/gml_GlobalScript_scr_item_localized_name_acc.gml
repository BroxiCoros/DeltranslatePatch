function scr_item_localized_name_acc(argument0, argument1, argument2) //gml_Script_scr_item_localized_name_acc
{
    ...
    switch (item) {
        ...
        case 1:
            return stringsetloc(stringsetloc("Darker Candy", "scr_itemnamelist_slash_scr_itemnamelist_gml_9_0_b"), "scr_itemnamelist_slash_scr_itemnamelist_gml_9_1_b");
        ...
        case 40:
            return stringsetloc(stringsetloc("PunchBowl", "scr_itemnamelist_slash_scr_itemnamelist_gml_126_0_b"), "scr_itemnamelist_slash_scr_itemnamelist_gml_126_1_b");

        case 41:
            return stringsetloc(stringsetloc("Flavigne", "scr_itemnamelist_slash_scr_itemnamelist_gml_129_0_b"), "scr_itemnamelist_slash_scr_itemnamelist_gml_129_1_b");

        case 42:
            return stringsetloc(stringsetloc("GreenTea", "scr_itemnamelist_slash_scr_itemnamelist_gml_132_0_b"), "scr_itemnamelist_slash_scr_itemnamelist_gml_132_1_b");

        case 43:
            return stringsetloc(stringsetloc("OrangeJuice", "scr_itemnamelist_slash_scr_itemnamelist_gml_135_0_b"), "scr_itemnamelist_slash_scr_itemnamelist_gml_135_1_b");
        ...
        case 64:
                return stringsetloc(stringsetloc("Schadenbrot", "scr_itemnamelist_slash_scr_itemnamelist_gml_150_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_150_1");

        case 65:
                return stringsetloc(stringsetloc("TreeCake", "scr_itemnamelist_slash_scr_itemnamelist_gml_153_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_153_1");

        case 66:
                return stringsetloc(stringsetloc("S.POTION", "scr_itemnamelist_slash_scr_itemnamelist_gml_156_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_156_1");

        case 67:
                return stringsetloc(stringsetloc("Raw Moon", "scr_itemnamelist_slash_scr_itemnamelist_gml_159_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_159_1");

        case 68:
                return stringsetloc(stringsetloc("Phanta", "scr_itemnamelist_slash_scr_itemnamelist_gml_162_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_162_1");

        case 69:
                return stringsetloc(stringsetloc("FlowerySoda", "scr_itemnamelist_slash_scr_itemnamelist_gml_165_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_132_1");

        case 70:
                return stringsetloc(stringsetloc("Shikacola", "scr_itemnamelist_slash_scr_itemnamelist_gml_168_0"), "scr_itemnamelist_slash_scr_itemnamelist_gml_168_1");
    ...
    switch item {
        ...
        case 30:
            return stringsetloc(stringsetloc("MonarchRBN", "scr_armorinfo_slash_scr_armorinfo_gml_713_0"), "scr_armorinfo_slash_scr_armorinfo_gml_713_1");

        case 31:
            return stringsetloc(stringsetloc("TrueTie", "scr_armorinfo_slash_scr_armorinfo_gml_739_0"), "scr_armorinfo_slash_scr_armorinfo_gml_739_1");

        case 32:
            return stringsetloc(stringsetloc("DogWidow", "scr_armorinfo_slash_scr_armorinfo_gml_763_0"), "scr_armorinfo_slash_scr_armorinfo_gml_763_1");

        case 33:
            return stringsetloc(stringsetloc("RedRibbon", "scr_armorinfo_slash_scr_armorinfo_gml_784_0"), "scr_armorinfo_slash_scr_armorinfo_gml_784_1");

        case 34:
            return stringsetloc(stringsetloc("NetskieHat", "scr_armorinfo_slash_scr_armorinfo_gml_811_0"), "scr_armorinfo_slash_scr_armorinfo_gml_811_1");

        case 35:
            return stringsetloc(stringsetloc("SethSpecs", "scr_armorinfo_slash_scr_armorinfo_gml_833_0"), "scr_armorinfo_slash_scr_armorinfo_gml_833_1");

        case 36:
            return stringsetloc(stringsetloc("YellowHat", "scr_armorinfo_slash_scr_armorinfo_gml_855_0"), "scr_armorinfo_slash_scr_armorinfo_gml_855_1");

        case 37:
            return stringsetloc(stringsetloc("O.Glove", "scr_armorinfo_slash_scr_armorinfo_gml_877_0"), "scr_armorinfo_slash_scr_armorinfo_gml_877_1");

        case 38:
            return stringsetloc(stringsetloc("GreenApron", "scr_armorinfo_slash_scr_armorinfo_gml_899_0"), "scr_armorinfo_slash_scr_armorinfo_gml_899_1");
    ...
    switch item {
        ...
        case 30:
            return stringsetloc(stringsetloc("WoodBlade2", "scr_weaponinfo_slash_scr_weaponinfo_gml_629_0_b"), "scr_weaponinfo_slash_scr_weaponinfo_gml_629_1_b");

        case 31:
            return stringsetloc(stringsetloc("Thatchet", "scr_weaponinfo_slash_scr_weaponinfo_gml_652_0_b"), "scr_weaponinfo_slash_scr_weaponinfo_gml_652_1_b");

        case 32:
            return stringsetloc(stringsetloc("BlueShoes", "scr_weaponinfo_slash_scr_weaponinfo_gml_675_0_b"), "scr_weaponinfo_slash_scr_weaponinfo_gml_675_1_b");

        case 33:
            return stringsetloc(stringsetloc("AquaKnife", "scr_weaponinfo_slash_scr_weaponinfo_gml_698_0_b"), "scr_weaponinfo_slash_scr_weaponinfo_gml_698_1_b");

        case 34:
            return stringsetloc(stringsetloc("FloweryScarf", "scr_weaponinfo_slash_scr_weaponinfo_gml_721_0_b"), "scr_weaponinfo_slash_scr_weaponinfo_gml_721_1_b");

        case 35:
            return stringsetloc(stringsetloc("BrokenScarf", "scr_weaponinfo_slash_scr_weaponinfo_gml_744_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_744_1");

        case 36:
            return stringsetloc(stringsetloc("GildedRose", "scr_weaponinfo_slash_scr_weaponinfo_gml_767_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_767_1");

        case 37:
            return stringsetloc(stringsetloc("MistleWP", "scr_weaponinfo_slash_scr_weaponinfo_gml_790_0"), "scr_weaponinfo_slash_scr_weaponinfo_gml_790_1");
    ...
    switch item {
        ...
        case 20:
            return stringsetloc(stringsetloc("Scissors", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_186_0_b"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_186_1_b");

        case 21:
            return stringsetloc(stringsetloc("YellowShred", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_191_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_191_1");

        case 22:
            return stringsetloc(stringsetloc("BootOil", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_196_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_196_1");

        case 23:
            return stringsetloc(stringsetloc("RedSplatter", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_201_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_201_1");

        case 24:
            return stringsetloc(stringsetloc("BromideR", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_206_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_206_1");

        case 25:
            return stringsetloc(stringsetloc("PetalFeather", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_212_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_212_1");

        case 26:
            return stringsetloc(stringsetloc("PerpBook", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_223_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_223_1");

        case 27:
            return stringsetloc(stringsetloc("BlueString", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_228_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_228_1");

        case 28:
            return stringsetloc(stringsetloc("TrainPlan", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_233_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_233_1");

        case 29:
            return stringsetloc(stringsetloc("YellowKey", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_238_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_238_1");
        ...
        case 32:
            return stringsetloc(stringsetloc("MysteryKey", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_254_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_254_1");

        case 33:
            return stringsetloc(stringsetloc("BromideF", "scr_keyiteminfo_slash_scr_keyiteminfo_gml_259_0"), "scr_keyiteminfo_slash_scr_keyiteminfo_gml_259_1");
    ...
    switch item {
        ...
        case 18:
            return stringsetloc(stringsetloc("QuillPen", "scr_litemname_slash_scr_litemname_gml_24_0_b"), "scr_litemname_slash_scr_litemname_gml_24_1_b");
        case 19:
            return stringsetloc(stringsetloc("Honey Toast", "scr_litemname_slash_scr_litemname_gml_25_0"), "scr_litemname_slash_scr_litemname_gml_25_1");
        case 20:
            return stringsetloc(stringsetloc("Bread", "scr_litemname_slash_scr_litemname_gml_26_0"), "scr_litemname_slash_scr_litemname_gml_26_1");
        case 21:
            return stringsetloc(stringsetloc("Seeds", "scr_litemname_slash_scr_litemname_gml_27_0"), "scr_litemname_slash_scr_litemname_gml_27_1");
        case 22:
            return stringsetloc(stringsetloc("Pencil2", "scr_litemname_slash_scr_litemname_gml_28_0"), "scr_litemname_slash_scr_litemname_gml_28_1");
        case 23:
            return stringsetloc(stringsetloc("Petal", "scr_litemname_slash_scr_litemname_gml_29_0"), "scr_litemname_slash_scr_litemname_gml_29_1");
