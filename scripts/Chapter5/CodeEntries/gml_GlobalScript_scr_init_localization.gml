...
function scr_lang_load_assets()
{
    ...
    // Las fuentes-sprite de numeros (damage/hp) dependen de sprites que el
    // pack localiza, asi que hay que rehacerlas tras un cambio de idioma. Se
    // registran como loader; lo invoca quien active el idioma (la rama de
    // cache de `scr_init_localization` y `scr_lang_preload_others`). En el
    // boot no se llama: alli las crea `obj_initializer2_Create_0`.
...
// del idioma nuevo. Lo llama `scr_init_localization`.
