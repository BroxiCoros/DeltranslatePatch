// Variante del Cap.5 de obj_lang_settings_Step_0: es idéntica a la compartida
// (SharedCodeEntries/LangSettingsThings) salvo que, al togglear special_mode,
// reinicia las voces de Flowery con scr_floweryvoiceclip_init() (solo existe en
// el Cap.5). Mantener en sincronía con la compartida al tocar aquella.
...
if (option < options_count) {
    ...
    if (options[option] == "special_mode") {
        if (left_p() || right_p() || button1_p()) {
            ...
            audio_play_sound(snd_menumove, 50, 0)
            // Cap.5: reinicia las voces de Flowery con el nuevo modo.
