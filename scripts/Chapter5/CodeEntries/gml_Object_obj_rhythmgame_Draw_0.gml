...
if (chart_ease > 0)
{
    ...
    draw_sprite_ext(scr_84_get_sprite("spr_rhythmgame_popularity"), 0, x + 60 + (110 * _inv_ease), (_ystart - 60 - 30) + 4, 1, 1, 0, spotlight_color[2], 1);
    draw_sprite_ext(scr_84_get_sprite("spr_rhythmgame_popularity"), 1, (x + camerawidth()) - 60 - (110 * _inv_ease), (_ystart - 60 - 30) + 4, 1, 1, 0, spotlight_color[2], 1);
    draw_set_halign(fa_left);
...
if ((song_initialized && intro_con >= 2) || kchart_ease > 0)
{
    ...
    if (tenna_boss && speed_modifier >= 2)
    {
        ...
        draw_text_transformed(_centerx + 50, bottomy + 40, stringsetloc("SPEED", "obj_rhythmgame_slash_Draw_0_gml_418_0"), 1, 1, 0);
    }
    ...
    with (obj_rhythmgame_chart)
    {
        ...
        scr_rhythmgame_draw(_notespeed, x);
    }
}
...
if (show_debug)
{
    ...
    draw_set_color(c_red);
    draw_text(10, 0, "track pos: " + string(trackpos) + " / " + string(track_length));
    draw_text(10, 20, "fame: " + string(fame) + " / 12600");
    draw_text(10, 40, notetime[0]);
    draw_text(10, 60, "meter: " + string(trackpos / meter));
    var _sigmul = signature % 1;
    
    if (_sigmul == 0)
        _sigmul = 1;
    
    draw_text(10, 80, "Time Signature: " + string(signature / _sigmul) + "/" + string(4 / _sigmul));
    draw_text(10, 100, "BPM: " + string(bpm));
}
