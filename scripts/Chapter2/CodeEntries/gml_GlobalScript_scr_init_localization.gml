// AUTOGENERADO por tools/regen_localization.csx desde scripts/Chapter2/manifest.json.
...
function scr_init_localization()
{
    ...
    if (global.lang_loaded != global.lang)
    {
        var sprites_list = [
            ...
            "spr_city_mice_in",
            "spr_city_mice_out",
            "spr_city_mice_sign_01",
            "spr_city_mice_sign_02",
            "spr_city_mice_sign_03",
            "spr_cutscene_06_highfive",
            "spr_cutscene_27_tender_cancelled",
            "spr_cutscene_27_tender_goodbye",
            "spr_darkmenudesc",
            "spr_dmenu_captions",
            "spr_dw_city_info",
            "spr_dw_door_lancer",
            "spr_dw_mansion_room_susie_book_vacuum",
            "spr_face_queen",
            ...
            "spr_hpname",
            "spr_lw_conbini_open",
            "spr_mansion_cafe_entrance",
            "spr_mansion_floor_sign",
            "spr_mansion_switch_light",
            "spr_maus_intext",
            "spr_mice3_progressBar",
            "spr_npc_catti_mom_no1",
            "spr_pipissign",
            "spr_pressfront_b",
            "spr_queen_hp",
            "spr_queen_poster",
            "spr_queenmansion_bg_middle",
            "spr_queenscreen",
            "spr_queenscreen_large",
            "spr_quitmessage",
            "spr_rouxls_bubble_hey",
            "spr_sneo_playback",
            "spr_spare_z",
            "spr_susie_wan_sign",
            "spr_tiredmark",
            "spr_tm_letters",
            "spr_tplogo",
            "spr_trafficswitch_symbol",
            "spr_welcome_sign",
            "spr_werewire_zzt_text",
            "spr_cutscene_13_berdly_statue",
            "spr_cutscene_26_berdly_statue",
            "spr_cutscene_26_plugboy",
            "spr_dw_mansion_toilet",
            "spr_headkris",
            "spr_headnoelle",
            "spr_headralsei",
            "spr_headsusie",
            "spr_npc_plugboy",
            "spr_npc_plugboy_bandana",
            "spr_npc_plugboy_girl",
            "spr_npc_plugboy_hat",
            "spr_npc_plugboy_shock",
            "spr_npc_plugboy_static",
            "spr_npc_plugboy_static_outline",
            "spr_npc_plugboy_wig",
            "spr_plugboy_cower",
            "spr_plugboy_shock",
            "spr_plugboy_spare",
        ...
        var sounds_list = [
            ...
            "snd_boxing_fight_bc",
            "snd_boxing_round1",
            "snd_boxing_round1_bc",
            "snd_boxing_round2",
            "snd_boxing_round2_bc",
            "snd_boxing_round3",
            "snd_boxing_round3_bc",
            "snd_tm_quiz_a",
            "snd_tm_quiz_b",
            "snd_tm_quiz_c",
            "snd_tm_quiz_d"
