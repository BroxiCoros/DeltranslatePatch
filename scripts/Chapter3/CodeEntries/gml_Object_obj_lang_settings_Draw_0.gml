// Codigo adaptado de DEVICE_MENU (animaciones de fondo y BG_ALPHA fade)
...
for (var i = 0; i < options_count; i++) {
    ...
    if (options[i] == "special_mode") {
        ...
        // Texto del valor actual. Si hay más de un modo, pistas de ciclo
        // con "< >". Si solo hay uno (compat viejo), se mantiene el look
        // original de "Yes / No".
