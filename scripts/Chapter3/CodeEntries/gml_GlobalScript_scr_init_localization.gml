...
function scr_init_localization()
{
    ...
    {
        var sprites_list = [
            "spr_funnytext_amazing_01",
            "spr_gameshow_screen_theend_bonus",
            "spr_susie_wan_sign",
            ...
            "spr_board_tvtimelogo",
            "spr_board_healthbar",
            "spr_dw_ranking_door_z",
            "spr_arcade_time",
            "spr_quitmessage",
            "spr_sneo_playback",
            "spr_funnytext_bonus_round",
            "spr_castle_dojo",
            "spr_dw_tv_prizes",
            "spr_board_b3stairdoor_big",
            "spr_quiz_answer_cursor",
            "spr_dw_ranking_door_a",
            "bg_building_icee_sign",
            "spr_funnytext_tv_time",
            "spr_dw_interstitial_poster_next",
            "spr_funnytext_tears",
            "spr_btact_fail1",
            "spr_gameshow_screen_chef_logo",
            "spr_tenna_pose_headraised_zoom_greenscreen",
            "bg_dw_b3bs_interstitial",
            "bg_building_cattyhouse",
            "spr_tenna_pose_headlowered",
            "spr_dw_green_room_bar_back",
            "spr_lancer_susie_highfive",
            "spr_darkmenudesc",
            "spr_tenna_desperate",
            "spr_chef_screen_logo",
            "IMAGE_LOGO",
            "spr_dw_tv_mysertySign_killed",
            "bg_dw_tvland_backstage_tiles_old",
            "spr_board_b2_lancerhint",
            "spr_btitem",
            "spr_funnytext_game_over",
            "bg_dw_tvland_stage_tiles_old",
            "spr_funnytext_stars",
            "spr_gigaqueen_intro_round1",
            "spr_board_quiztile",
            "spr_hopeometer_hope",
            "spr_hopeometer_flowers",
            "spr_hopeometer_bar",
            "spr_funnytext_resumes",
            "spr_dw_gameshow_screen_round_3_bonus_backup",
            "spr_dw_interstitial_doors_sign_outline",
            "spr_board_sleep",
            "spr_tenna_pose_headraised_nose",
            "spr_board_sphinx_base",
            "spr_fieldmuslogo",
            "spr_dw_tv_tvtimeSign_quizwipe",
            "spr_tenna_tie_adjust_c",
            "spr_tenna_tie_adjust_b",
            "spr_dw_susiezilla_bg_empty",
            "spr_ch2_keyboard_tile_text",
            "spr_dw_tv_prize_talkback",
            "spr_board_inventory_q",
            "spr_board_b3stairdoor",
            "spr_board_b3stairs",
            "spr_funnytext_special",
            "spr_funnytext_alligator",
            "spr_tiredmark",
            "spr_funnytext_grand_prize",
            "spr_quiz_results",
            "spr_funnytext_big",
            ...
            "spr_funnytext_stop",
            "spr_headralsei",
            "spr_board_treasuremarker_lmarkonly",
            "spr_funnytext_relax",
            "spr_face_rurus_piratehat",
            "spr_tenna_snap_body",
            "spr_tm_letters",
            "spr_dw_tv_tvtimeSign_animated",
            "spr_board_treasuremarker",
            "spr_tv_counter_letters",
            "spr_tenna_tie_adjust_a",
            "spr_headkris",
            "spr_gameshow_halloffame_right",
            "bg_torielclass",
            "spr_susiezilla_background",
            "spr_tenna_grasp_chef2",
            "spr_zapper_caption2",
            "spr_board_yogurtemergency",
            "bg_building_townhall_layer2",
            "spr_headnoelle",
            "spr_rouxls_biplane_flag",
            ...
            "spr_dw_tv_time_02",
            "spr_dw_gameshow_screen_bonus_confirmed",
            "spr_dw_tv_mysterySign",
            "spr_acrade_fightagain",
            "spr_gigaqueen_intro_fight",
            "spr_tenna_snap_body_f2",
            "spr_funnytext_over_small",
            "spr_dw_tv_time_03",
            "spr_funnytext_brother",
            "bg_building_flowershop",
            "spr_dw_tv_time_intro",
            "spr_tplogo",
            "spr_susie_chef_doubleres",
            "spr_bnamekris",
            "spr_board_freeroamTrigger",
            "spr_dw_tv_time_01",
            "spr_tenna_kick",
            "spr_chirashi_bullet",
            "spr_flowershop_sign",
            "IMAGE_LOGO_CENTER_SEPARATE",
            "spr_board_game_title",
            "spr_btspade_success2",
            "spr_btfight",
            "spr_marquee_debug",
            "bg_library",
            "spr_dw_green_room_door_changing",
            "spr_funnytext_hall_of_fame",
            "bg_torielclass_ch2",
            "spr_smashreveal3",
            "spr_zapper_caption3",
            ...
            "spr_dw_interstitial_doors",
            "spr_gameshow_screen_halloffame",
            "spr_dw_tv_time_04",
            "spr_elevator_floornum",
            "spr_btact_red",
            "spr_arcade_fight",
            ...
            "spr_chartarget",
            "spr_queen_hp",
            "spr_gameshow_screen_theend_bonus_bonus",
            "spr_dw_ch3_b3bs_stealthzone",
            "spr_gameshow_screen_round_1_end",
            "spr_dw_tv_mysterySign_half",
            "bg_dw_castle_music_shop",
            "spr_bnamenoelle",
            "spr_tenna_hooray_chef",
            "spr_tenna_hooray",
            "spr_tenna_laugh_pose_alt",
            "spr_funnytext_physical_challenges",
            "spr_funnytext_board",
            "spr_btrouxls",
            "spr_ch3_wheel_center",
            "spr_board_game_title_tvtime",
            "spr_dw_teevie_tv_shows_tenna3",
            "spr_dw_tv_tvtimeSign_half",
            "spr_dw_ch3_latenitesign",
            "bg_building_diner",
            "bg_dw_music_ext",
            "spr_funnytext_flames",
            "spr_quiz_thisbutton",
            "spr_btheart",
            "spr_dw_green_room_poster_left",
            "bg_building_store",
            "spr_funnytext_lovers",
            ...
            "spr_gigaqueen_intro_round3",
            "spr_btrouxls_select1",
            "spr_funnytext_round",
            "spr_dw_ranking_door_b",
            "spr_tenna_t_pose",
            "spr_tenna_whisper_chef",
            "spr_funnytext_over",
            "spr_funnytext_gentle",
            "spr_susiezilla_hudguy_tim",
            "spr_gameshow_screen_theend_round_1",
            ...
            "spr_btact_ex",
            "spr_dw_tv_prize_car",
            "spr_dw_ranking_door_c",
            "spr_tenna_point_at_screen_c",
            "spr_tenna_grasp_b",
            "spr_btrouxls_select2",
            "spr_gigaqueen_intro_round2",
            "spr_btact_fail2",
            "spr_board_q",
            "spr_funnytext_quizzes",
            "spr_tenna_whisper",
            "spr_hero_hp",
            "spr_tenna_grasp_c",
            "spr_funnytext_game",
            ...
            "spr_tenna_jumpscare",
            "spr_tenna_t_pose_uncleaned",
            "spr_castle_shop",
            "spr_tenna_laugh_pose_segmented_body",
            "spr_rhythmgame_bg",
            "spr_arcade_youlose",
            "spr_recovery_platform_glow",
            "spr_bnamesusie",
            "spr_dw_screen_technical_difficulties",
            "spr_tenna_grasp_d",
            "bg_lw_ice_e_pizza",
            "spr_btspare",
            "bg_lw_sans_conbini",
            "spr_castle_shop_new",
            "spr_dw_tv_funometer_base",
            "spr_dw_tv_funometer_hopeText",
            "saloon_Train_NoneMove",
            "IMAGE_LOGO_CENTER_CHAPTERNUMBER",
            "spr_face_queen",
            "spr_tenna_laugh_pose_teeth",
            "spr_gameshow_screen_logo",
            "spr_tenna_fall_start",
            "spr_dw_tv_time_intro_loop",
            "spr_ch3_gameshow_round",
            "spr_tenna_grasp_zoom_static",
            "bg_building_library",
            "spr_checkers_milk",
            "spr_dw_green_room_poster",
            "spr_tenna_sad",
            "spr_acrade_giveup",
            "spr_gameoverbg_neo",
            "spr_tenna_attack_mouth_open",
            "spr_shadowman_caption2",
            "spr_funnytext_word",
            "spr_tenna_frightened",
            "spr_tenna_grasp",
            "spr_shootout_train_new",
            "spr_dw_green_room_bar_front",
            "spr_chefs_catch",
            "spr_dw_teevie_rhythm_bg",
            "bg_building_icee",
            "spr_dw_tv_tvtimeSign_off",
            "spr_funnytext_names",
            "spr_gameshow_screen_theend",
            "spr_funnytext_rock_concert",
            "spr_funnytext_tan",
            "spr_funnytext_lovely",
            "spr_dw_ranking_t_explain",
            "spr_funnytext_free",
            "spr_maus_intext",
            "spr_lw_conbini_open",
            "spr_ch3_GSA01G_tvtimescreenshot",
            "spr_dw_teevie_tv_shows",
            "spr_quiz_images",
            "spr_board_yogurtemergency_text",
            "spr_funnytext_fun_loop",
            "spr_chefs_food",
            "spr_dw_tv_funometer_hope",
            "spr_funnytext_physical_challenge",
            "spr_funnytext_round_1",
            "spr_funnytext_green_room",
            "spr_gameshow_screen_logo_white",
            "spr_chef_tutorial_03",
            "spr_tenna_attack",
            "spr_funnytext_toriel",
            "spr_funnytext_breaking_news",
            "spr_pressfront_b",
            "spr_dw_tv_time_funnytext",
            "spr_tenna_attack_clapvfx",
            "spr_funnytext_dark_fountain",
            "spr_tenna_snap",
            "spr_dw_tv_time_sample",
            "spr_dw_tv_mysterySign_gray",
            "spr_bnameralsei",
            "spr_dw_tv_funometer_base_1x",
            "spr_dw_poster_chef",
            "spr_dw_tv_tvtimeSign_off_gray",
            "spr_funnytext_prizes",
            "spr_tenna_hooray_armsup_teeth",
            "spr_btheart_success1",
            "spr_werewire_zzt_text",
            "spr_castle_cafe",
            "bg_alphysalley",
            "spr_funnytext_star",
            "spr_gameshow_screen_theend_bonus_start",
            "spr_castle_restaurant",
            "spr_susiezilla_hudguy_hp",
            "spr_susiezilla_singlescreen_hpbar",
            "bg_building_hospital",
            "spr_dw_tv_funometer_base_2x",
            "spr_dw_gameshow_screen_news",
            "spr_gameoverbg",
            "spr_tenna_grasp_anim_b",
            "spr_zapper_volume_text",
            "spr_tvlandfont",
            "spr_dw_tv_tvtimeSign",
            "spr_tenna_pose",
            "bg_building_police",
            "bg_dw_dojo_help",
            "spr_btspade",
            ...
            "spr_dw_gameshow_screen_round_3_bonus",
            "spr_dw_inbetween_room_door",
            "spr_ch2_gimmick_bombtext_0",
            "bg_dw_castle_cafe_in",
            "spr_shootout_train",
            "spr_funnytext_love",
            "spr_tenna_laugh",
            "spr_gameshow_screen_chef_food",
            "spr_dw_tv_time_lights",
            "spr_board_shop",
            "spr_dw_tv_word_poster",
            "spr_board_lancercactus_help",
            "spr_ch3_chef_specialguestText",
            "spr_dw_ch3_b3bs_officesign_strip2",
            "spr_npc_bibliox_up",
            "spr_npc_bibliox",
            "obj_susiezilla_statue",
            "spr_gameshow_screen_city",
        ...
        // Fuente derivada del sprite spr_tvlandfont (running line del rhythm game).
