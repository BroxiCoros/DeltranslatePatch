...
function scr_lang_load_assets()
{
    ...
    // localiza, asi que hay que rehacerla en cada cambio de idioma. Se
    // registra como loader para quien active el idioma desde la cache, y se
    // construye aqui mismo porque los sprites acaban de cargarse arriba.
    // Ver `scr_reload_tvlandfont`.
...
// (button sounds del speak-and-spell + sounds_list + funny sounds).
